...
public class B314TestCommentsSemanticsTest {

    private static final Logger LOG = LoggerFactory.getLogger(B314TestCommentsSemanticsTest.class);
    ...
    @Test
    public void testTestComments_empty() throws Exception{
        File pcodeFile = testFolder.newFile();
        CompilerTestHelper.launchCompilation("/semantics/TestComments/empty.b314", pcodeFile, true, "TestComments: empty");
