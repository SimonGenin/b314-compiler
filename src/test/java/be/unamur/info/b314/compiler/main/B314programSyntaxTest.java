...
public class B314programSyntaxTest {
    ...
    //
    @Test
    public void testprogram_missing_declare_bloc_ko() throws Exception {
        CompilerTestHelper.launchCompilation("/syntax/program/ko/missing_declare_bloc.b314", testFolder.newFile(), false, "program: missing_declare_bloc");
    }

    @Test
    public void testprogram_missing_default_bloc_ko() throws Exception {
        CompilerTestHelper.launchCompilation("/syntax/program/ko/missing_default_bloc.b314", testFolder.newFile(), false, "program: missing_default_bloc");
    }
